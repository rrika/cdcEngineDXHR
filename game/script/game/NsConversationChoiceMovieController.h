...
class NsConversationChoiceMovieController : public NsScaleformMovieController {
public:
	NsConversationChoiceMovieController(cdc::ScriptType *ty) : NsScaleformMovieController(ty) {}
