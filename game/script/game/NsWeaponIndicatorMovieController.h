...
class NsWeaponIndicatorMovieController : public NsScaleformMovieController {
public:
	NsWeaponIndicatorMovieController(cdc::ScriptType *ty) : NsScaleformMovieController(ty) {}
