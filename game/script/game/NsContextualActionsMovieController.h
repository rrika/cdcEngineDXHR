...
class NsContextualActionsMovieController : public NsScaleformMovieController {
public:
	NsContextualActionsMovieController(cdc::ScriptType *ty) : NsScaleformMovieController(ty) {}
