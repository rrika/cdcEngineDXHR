...
class NsStealthEnhancerMovieController : public NsScaleformMovieController {
public:
	NsStealthEnhancerMovieController(cdc::ScriptType *ty) : NsScaleformMovieController(ty) {}
