...
class NsContextualLegendsMovieController : public NsScaleformMovieController {
public:
	NsContextualLegendsMovieController(cdc::ScriptType *ty) : NsScaleformMovieController(ty) {}
