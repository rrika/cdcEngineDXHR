...
class NsSocialAugmentationMovieController : public NsScaleformMovieController {
public:
	NsSocialAugmentationMovieController(cdc::ScriptType *ty) : NsScaleformMovieController(ty) {}
