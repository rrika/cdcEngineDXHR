...
class NsPersonalityTypeMovieController : public NsScaleformMovieController {
public:
	NsPersonalityTypeMovieController(cdc::ScriptType *ty) : NsScaleformMovieController(ty) {}
