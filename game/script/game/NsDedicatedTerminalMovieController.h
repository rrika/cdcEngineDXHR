...
class NsDedicatedTerminalMovieController : public NsScaleformMovieController {
public:
	NsDedicatedTerminalMovieController(cdc::ScriptType *ty) : NsScaleformMovieController(ty) {}
